...
public class SEARCH_UPDATE_DELETE extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SEARCH_UPDATE_DELETE frame = new SEARCH_UPDATE_DELETE();
	...
	public SEARCH_UPDATE_DELETE() {
		...
		JLabel lblAddNewBook = new JLabel("SEARCH, UPDATE AND DELETE BY BOOK ID");
		...
		btnUpdate.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				String s10=(String) comboBox_4.getSelectedItem();
				
				Connection con=DBinfo.getConn("library");
				String query="update book set Title=?,Author=?,Subject=?,Category=?,Publication=?,ISBN=?,Edition=?,Price=?,Quantity=? where ID=?";
				...
				if(i==1)
				{
					JOptionPane.showMessageDialog(getParent(), "book updated!!","done", JOptionPane.INFORMATION_MESSAGE);
				}
				if(i==0)
				{
					JOptionPane.showMessageDialog(getParent(), "book not found","error",JOptionPane.ERROR_MESSAGE);
				}
		...
		btnDelete.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if(i==1)
				{
					JOptionPane.showMessageDialog(getParent(), "book deleted!!","done", JOptionPane.INFORMATION_MESSAGE);
				}
				if(i==0)
				{
					JOptionPane.showMessageDialog(getParent(), "book not found","error",JOptionPane.ERROR_MESSAGE);
